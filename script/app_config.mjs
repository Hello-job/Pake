...
const variables = {
  ...
  linux: {
    ...
    defaultIconPath: 'src-tauri/png/mingdaoyun_512.png',
  ...
  macos: {
    ...
    defaultPath: 'src-tauri/icons/mingdaoyun.icns',
  ...
  windows: {
    ...
    defaultPath: 'src-tauri/png/mingdaoyun_32.ico',
    hdIconPath: `src-tauri/png/${process.env.NAME}_256.ico`,
    hdDefaultPath: 'src-tauri/png/mingdaoyun_256.ico',
